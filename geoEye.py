...
# As of rn, the values below should be enough to give you a lattitude, a longitude, country name/location and maybe a roadname and or a road number. You can change this if you need.
